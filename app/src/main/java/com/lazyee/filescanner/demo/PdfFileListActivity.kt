...
import com.lazyee.filescanner.klib.config.PdfScanConfig
 ...
 */
class PdfFileListActivity : ViewBindingActivity<ActivityImageFileListBinding>() ,
    OnFileScanListener {
